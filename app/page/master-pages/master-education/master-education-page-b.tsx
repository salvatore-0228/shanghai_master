...
export default function MasterEducationPageB() {
    ...
    return (
        <div className="h-full w-full px-4 sm:px-6 py-4 sm:py-6 dark:bg-gray-900 dark:text-white overflow-y-scroll scrollbar-thin scrollbar-thumb-red-500 scrollbar-track-gray-200">
            <div className="lg:text-base md:text-lg sm:text-sm flex lg:flex-row flex-col gap-[2rem] lg:h-[100%]">
                ...
                <div className="flex lg:flex-row flex-col flex-1 justify-between lg:w-1/2 gap-[1rem]">
                    <div className="flex flex-1 flex-col lg:w-[50%]  gap-[1rem]">
                        <h1 className="dark:border-white pt-[0.5rem] pb-[0.5rem]" style={{ fontSize: "2rem", fontWeight: "700", textTransform: "uppercase", borderTop: "5px solid", borderBottom: "1px solid" }}>
                            Education
                        </h1>
                        <div className="flex flex-1 text-justify" style={{ textAlignLast: "justify" }} ref={divRef1}>
                            {part[0]}
                        </div>
                        <div className="bg-black lg:h-[calc(25dvw*9/16)]">
                            <video src="/videos/cover.mp4" style={{ width: "100%", margin: "auto" }} controls></video>
                        </div>
                    </div>
                    <div className="flex flex-1 text-justify" style={{ textAlignLast: "justify" }} ref={divRef2}>
                        {part[1]}
                    </div>
                </div>
                ...
                {/* Right Column */}
                <div className="flex lg:flex-row flex-col flex-1 justify-between lg:w-1/2 gap-[1rem]">
                    <div className="lg:w-[50%]  gap-[1rem] text-justify" style={{ textAlignLast: "justify" }} ref={divRef3}>
                        {part[2]}
                    </div>
                    <div className="flex flex-col lg:w-[50%]  gap-[1rem]">
                        ...
                        <div className="flex-1 text-justify mt-[1rem]" ref={divRef4}>
                            {part[3]}
                        </div>
                        <div className="flex flex-1 gap-[1rem] border-t-4 border-b-4 dark:border-white">
                            <div className={`flex-1 relative text-center`} style={{ position: "relative", fontFamily: "auto" }}>
                                <p
                                    className="dark:text-white-100 opacity-20 lg:text-[450px] text-[40dvh]"
                                    style={{
                                        position: "absolute",
                                        top: "60%",
                                        left: "50%",
