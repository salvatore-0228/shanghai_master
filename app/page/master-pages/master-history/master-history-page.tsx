...
export default function MasterHistoryPage() {
    ...
    useEffect(() => {
        ...
        console.log(divRef1.current?.offsetHeight, divRef1.current?.offsetWidth)
    ...
    return (
        <div className="h-full w-full px-6 pb-6 sm:px-6 py-6 sm:py-6 dark:bg-gray-900 dark:text-white lg:overflow-hidden overflow-auto h-full scrollbar-thin scrollbar-thumb-red-500 scrollbar-track-gray-200">
            <div className="flex lg:flex-row flex-col gap-[2rem]" style={{ height: "100%" }}>
                ...
                <div className="flex lg:flex-row flex-col flex-1 gap-[1rem]">
                    <div className="gap-[1rem] flex flex-col flex-1">
                        ...
                        <div className="flex-1 text-justify" style={{ textAlignLast: "justify" }} ref={divRef1}>
                            {part[0]}
                        </div>
                    </div>
                ...
                <div className="flex lg:flex-row flex-col flex-1 lg:w-1/2 gap-[1rem] text-justify">
                    <div className="flex flex-1 flex-col gap-[1rem]">
                        <div className="flex-1" ref={divRef3}>
                            {part[2]}
                        </div>
                        <h2 className={`dark:border-white-600 border-black-600 ${styles.paragraphSubheading} pt-[1rem] pb-[1rem]`}>A Brief History of Shanghai</h2>
                        <div>
                            <div className={styles.dropCap}>
                                <span className={styles.firstLetter}>
                                    S
                        ...
                        <div className="flex-1" style={{ textAlignLast: "justify" }} ref={divRef4}>
                            {part[3]}
                        </div>
                    </div>

                    <div className="flex flex-col flex-1 text-justify gap-[1rem]">
                        <div className={`flex flex-1 ${styles.mainBody}`} ref={divRef5}>
                            {part[4]}
                        </div>
